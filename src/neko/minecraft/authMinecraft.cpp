...
namespace neko::minecraft::auth {
     ...
     */
    void authMinecraftTokenRefresh(AuthMode authMode) {
        log::autoLog log;
     ...
     */
    LoginResult authLogin(const std::vector<std::string> &inData, AuthMode authMode) noexcept {
        log::autoLog log;
        LoginResult result;
    ...
    void authLogout(AuthMode authMode) noexcept {
        log::autoLog log;
