...
namespace neko {
    ...
    bool Network::multiThreadedDownload(const MultiDownloadConfig &config) {
        ...
        logInfo(
                "Network::multiThreadedDownload() : ",
            "Download strategy: " + std::string(
                config.approach == MultiDownloadConfig::Approach::Auto ? "Auto" : 
                config.approach == MultiDownloadConfig::Approach::Thread ? "Thread" :
                config.approach == MultiDownloadConfig::Approach::Size ? "Size" : "Quantity") +
