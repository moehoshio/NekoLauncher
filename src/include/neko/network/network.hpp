...
namespace neko {
    ...
    struct RequestConfig {
        ...
        RequestConfig& setUrl(const std::string &u) { url = u; return *this; }
        RequestConfig& setMethod(NetworkBase::RequestType m) { method = m; return *this; }
        RequestConfig& setUserAgent(const std::string &ua) { userAgent = ua; return *this; }
        RequestConfig& setProxy(const std::string &p) { proxy = p; return *this; }
        RequestConfig& setRequestId(const std::string &id) { requestId = id; return *this; }
        RequestConfig& setHeader(const std::string &h) { header = h; return *this; }
        RequestConfig& setData(const std::string &d) { postData = d; return *this; }
        RequestConfig& setOutputFile(const std::string &f) { fileName = f; return *this; }
        RequestConfig& setResumable(bool r) { resumable = r; return *this; }
        RequestConfig& setRange(const std::string &r) { range = r; return *this; }
