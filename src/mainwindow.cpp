...
namespace ui {
    ...
    MainWindow::SettingPageOne::SettingPageOne(QWidget *parent = nullptr) : QWidget(parent) {
    ...
    MainWindow::SettingPageTwo::SettingPageTwo(QWidget *parent = nullptr) : QWidget(parent) {
        ...
        bgSelectRadioVideo = new QRadioButton(bgSelectLayoutWidget);
        ...
        bgSelectButtonGroup->addButton(bgSelectRadioVideo, 3);
        ...
        bgSelectLayout->addWidget(bgSelectRadioVideo);
    ...
    MainWindow::Setting::Setting(QWidget *parent = nullptr) : QWidget(parent) {
            ...
            switch (state) {
                ...
                case pageState::setting:
                    ...
                    for (auto setGroupMMSize : std::vector<QWidget *>{setting->page2->bgGroup, setting->page2->winGroup, setting->page2->styleGroup, setting->page2->netGroup}) {
                        setGroupMMSize->setMinimumHeight(std::max<double>(220, height() * 0.35));
                        setGroupMMSize->setMaximumHeight(std::max<double>(680, height() * 0.75));
                    }
                    for (auto setOptBSize : std::vector<QWidget *>{setting->page2->bgSelectLayoutWidget, setting->page2->bgInputLayoutWidget, setting->page2->winSelectLayoutWidget, setting->page2->winSizeEditLayoutWidget, setting->page2->styleBlurEffectRadiusLayoutWidget, setting->page2->styleBlurEffectSelectLayoutWidget, setting->page2->netProxyLayoutWidget, setting->page2->netThreadLayoutWidget}) {
        ...
        void MainWindow::setupSize() {
            ...
            for (auto setMinHeight50 : std::vector<QWidget *>{setting->page1->accountLogInOutButton, setting->page2->bgInputLineEdit, setting->page2->winSizeEditWidth, setting->page2->winSizeEditHeight, setting->page2->styleBlurEffectRadiusSlider, setting->page2->netProxyEdit, setting->page2->netThreadSetNums}) {
         ...
         void MainWindow::setupStyle() {
            ...
            for (auto setTabOptBg : std::vector<QWidget *>{
                     setting->page2->bgSelectLayoutWidget, setting->page2->bgInputLayoutWidget, setting->page2->styleBlurEffectSelectLayoutWidget, setting->page2->winSelectLayoutWidget, setting->page2->winSizeEditLayoutWidget, setting->page2->styleBlurEffectRadiusLayoutWidget, setting->page2->netProxyLayoutWidget, setting->page2->netThreadLayoutWidget}) {
        ...
        void MainWindow::setupTranslucentBackground() {
            ...
            for (auto it : std::vector<QWidget *>{widget, index, setting->page1, setting->page2, setting->page3, setting->page2->pageScrollArea, setting->page2->scrollContent, setting->page2->bgSelectText, setting->page2->bgSelectRadioNone, setting->page2->bgSelectRadioImage, setting->page2->bgSelectRadioVideo, setting->page2->bgInputText, setting->page2->winBarKeepRightCheckBox, setting->page2->winSysFrameCheckBox, setting->page2->winSizeEditText, setting->page2->winSizeEditTextX, setting->page2->styleBlurEffectSelectText, setting->page2->styleBlurEffectSelectRadioPerformance, setting->page2->styleBlurEffectSelectRadioQuality, setting->page2->styleBlurEffectSelectRadioAnimation, setting->page2->styleBlurEffectRadiusText, setting->page2->netProxyEnable, setting->page2->netThreadAutoEnable, setting->page2->styleBlurEffectRadiusSpacing}) {
        ...
        void MainWindow::setupText() {
            ...
            setting->page2->bgSelectRadioVideo->setText("video");
            ...
            connect(setting->page2->bgSelectButtonGroup, &QButtonGroup::buttonClicked, [=, this]() {
                ...
                switch (id) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        setting->page2->bgSelectText->setText("video");
                        break;
                    default:
                        break;
                }
