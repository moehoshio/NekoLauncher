        ...
        switch (state) {
            ...
            case pageState::update: {
                ...
                if (setting->page2->winSysFrameCheckBox->isChecked())
                    ...
                    h1 = this->height() - headbar->height();
                update_->loadingLabel->setGeometry(10, h1 * 0.85, width() * 0.07, h1 * 0.08);
